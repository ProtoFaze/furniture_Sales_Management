...
import Classes.User;
import com.degreeJava.yoyosh.YoYoSH;
...
public class GenerateDocument extends javax.swing.JPanel {
    ...
    public boolean isWithinRange(String id, Date inputStartDate, Date inputEndDate) {
        ...
        LocalDate searchStart = YoYoSH.DateToLocalDate(inputStartDate),
                searchEnd = YoYoSH.DateToLocalDate(inputEndDate);
        ...
        for(SalesOrder salesOrder : SalesOrder.salesOrders){
            ...
            LocalDate generationDate = YoYoSH.DateToLocalDate(new Date("today"));
